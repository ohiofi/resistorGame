...
<div id="main">
  ...
  <div id="video">
  		<img src="img/resistortutor1.png" width="450px"/>
  	</div>
  <p>How to play: Enter the correct resistor values or colors.</p>
  </div>
  <div class="tutorsplitter">
  ...
  <div id="gobackorcontinue" class="centered">
    ...
    <a href="resistors.php"><div class="button gobackorcontinue">
